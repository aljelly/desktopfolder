/* This code was mostly imported from elementary: https://github.com/elementary/scratch/blob/master/src/Dialogs/PreferencesDialog.vala
*
...
namespace DesktopFolder.Dialogs {
    public class Preferences : Gtk.Dialog {
        ...
        construct {
            ...
            add_action_widget (about_button, 0);
